...
namespace KnowYourRoute.School.Data.Repositories
{
    public class HardCodedSchoolRepository : HighSchoolRepository
    {
        ...
        private static Coordinates bookerTWashingtonCoordinates = new Coordinates { LongitudeX = 95.9700144m, LatitudeY = 36.1876506m };
        ...
        private static Coordinates centralCoordinates = new Coordinates {LongitudeX = -96.0271166m, LatitudeY = 36.162906m };
        ...
        private static Coordinates danielWebsterCoordinates = new Coordinates { LongitudeX = -96.0141712m, LatitudeY = 36.1059567m };
        ...
        private static Coordinates eastCentralCoordinates = new Coordinates { LongitudeX = -95.8408342m, LatitudeY = 36.1468751m };
        ...
        private static Coordinates mcClainCoordinates = new Coordinates { LongitudeX = -95.9732124m, LatitudeY = 36.2249116m };
        ...
        private static Coordinates memorialCoordinates = new Coordinates { LongitudeX = -95.9146927m, LatitudeY = 36.0788739m };
        
        private static HighSchool nathanHale = new HighSchool { Name = "Memorial High School", GooglePlaceID = "ChIJoQgADqfytocRPfIYSturbhE",Coordinates = nathanHaleCoordinates, Address = nathanHaleAddress };
        ...
        private static Coordinates nathanHaleCoordinates = new Coordinates { LongitudeX = -95.8970628m, LatitudeY = 36.1324199m };
        ...
        private static Coordinates thomasEdisonCoordinates = new Coordinates { LongitudeX = -95.945766m, LatitudeY = 36.1042799m };
        ...
        private static Coordinates willRogersCoordinates = new Coordinates { LongitudeX = -95.933252m, LatitudeY = 36.153701m, };
    }
}
